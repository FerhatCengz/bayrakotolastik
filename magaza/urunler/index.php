...
<body>
    <section class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12">
            ...
            <div class="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div id="dropdownSort1"
                        ...
                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(263px, 156px, 0px);">
            ...
            <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                        ...
                        <div class="mb-4 flex items-center justify-between gap-4">
                            ...
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <div id="tooltip-quick-look" role="tooltip"
                                    ...
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(209.5px, -875px, 0px);">
                                    Quick look
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(43.5px, 0px, 0px);">
                                    </div>
                                </div>
                                ...
                                <div id="tooltip-add-to-favorites" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(226px, -875px, 0px);">
                                    Add to favorites
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(67px, 0px, 0px);">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4 flex items-center justify-between gap-4">
                            ...
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <div id="tooltip-quick-look-2" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(209.5px, -349px, 0px);">
                                    Quick look
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(43.5px, 0px, 0px);">
                                    </div>
                                ...
                                <div id="tooltip-add-to-favorites-2" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(226px, -349px, 0px);">
                                    Add to favorites
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(67px, 0px, 0px);">
                                    </div>
                        ...
                        <div class="mb-4 flex items-center justify-between gap-4">
                            ...
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <div id="tooltip-quick-look-3" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(209.5px, 177px, 0px);"
                                ...
                                <div id="tooltip-add-to-favorites-3" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(226px, 177px, 0px);"
                                    data-popper-reference-hidden="" data-popper-escaped="">
                                    Add to favorites
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(67px, 0px, 0px);">
                        ...
                        <div class="mb-4 flex items-center justify-between gap-4">
                            ...
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <div id="tooltip-quick-look-4" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(209.5px, 703px, 0px);"
                                    data-popper-reference-hidden="" data-popper-escaped="">
                                    Quick look
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(43.5px, 0px, 0px);">
                                ...
                                <div id="tooltip-add-to-favorites-4" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(226px, 703px, 0px);"
                                    data-popper-reference-hidden="" data-popper-escaped="">
                                    Add to favorites
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(67px, 0px, 0px);">
                ...
                <div
                    ...
                    <div class="h-56 w-full">
                        <a href="#">
                            <img class="mx-auto h-full dark:hidden"
                                src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/xbox-light.svg" alt="">
                            <img class="mx-auto hidden h-full dark:block"
                                src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/xbox-dark.svg" alt="">
                        </a>
                    </div>
                    ...
                    <div class="pt-6">
                        <div class="mb-4 flex items-center justify-between gap-4">
                            ...
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <div id="tooltip-quick-look-5" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(209.5px, 1229px, 0px);"
                                    data-popper-reference-hidden="" data-popper-escaped="">
                                    Quick look
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(43.5px, 0px, 0px);">
                                ...
                                <div id="tooltip-add-to-favorites-5" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(226px, 1229px, 0px);"
                                    data-popper-reference-hidden="" data-popper-escaped="">
                                    Add to favorites
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(67px, 0px, 0px);">
                        ...
                        <a href="#"
                            class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Microsoft
                            Xbox Series X 1TB Gaming Console</a>
                ...
                <div
                    ...
                    <div class="h-56 w-full">
                        <a href="#">
                            <img class="mx-auto h-full dark:hidden"
                                src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/macbook-pro-light.svg" alt="">
                            <img class="mx-auto hidden h-full dark:block"
                                src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/macbook-pro-dark.svg" alt="">
                        </a>
                    </div>
                        ...
                        <div class="mb-4 flex items-center justify-between gap-4">
                            ...
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <div id="tooltip-quick-look-6" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(209.5px, 1755px, 0px);"
                                    data-popper-reference-hidden="" data-popper-escaped="">
                                    Quick look
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(43.5px, 0px, 0px);">
                                ...
                                <div id="tooltip-add-to-favorites-6" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(226px, 1755px, 0px);"
                                    data-popper-reference-hidden="" data-popper-escaped="">
                                    Add to favorites
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(67px, 0px, 0px);">
                ...
                <div
                    ...
                    <div class="h-56 w-full">
                        <a href="#">
                            <img class="mx-auto h-full dark:hidden"
                                src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/apple-watch-light.svg" alt="">
                            <img class="mx-auto hidden h-full dark:block"
                                src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/apple-watch-dark.svg" alt="">
                        </a>
                    </div>
                    ...
                    <div class="pt-6">
                        <div class="mb-4 flex items-center justify-between gap-4">
                            ...
                            <div class="flex items-center justify-end gap-1">
                                <button type="button" data-tooltip-target="tooltip-quick-look-7"
                                    class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                    <span class="sr-only"> Quick look </span>
                                    <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <div id="tooltip-quick-look-7" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(209.5px, 2281px, 0px);"
                                    data-popper-reference-hidden="" data-popper-escaped="">
                                    Quick look
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(43.5px, 0px, 0px);">
                                ...
                                <button type="button" data-tooltip-target="tooltip-add-to-favorites-7"
                                    class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                    <span class="sr-only"> Add to Favorites </span>
                                    <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        fill="none" viewBox="0 0 24 24">
                                ...
                                <div id="tooltip-add-to-favorites-7" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(226px, 2281px, 0px);"
                                    data-popper-reference-hidden="" data-popper-escaped="">
                                    Add to favorites
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(67px, 0px, 0px);">
                        ...
                        <a href="#"
                            class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Apple
                            Watch SE [GPS 40mm], Smartwatch</a>
                ...
                <div
                    ...
                    <div class="pt-6">
                        <div class="mb-4 flex items-center justify-between gap-4">
                            ...
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <div id="tooltip-quick-look-8" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(209.5px, 2807px, 0px);"
                                    data-popper-reference-hidden="" data-popper-escaped="">
                                    Quick look
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(43.5px, 0px, 0px);">
                                ...
                                <div id="tooltip-add-to-favorites-8" role="tooltip"
                                    class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                    data-popper-placement="top"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(226px, 2807px, 0px);"
                                    data-popper-reference-hidden="" data-popper-escaped="">
                                    Add to favorites
                                    <div class="tooltip-arrow" data-popper-arrow=""
                                        style="position: absolute; left: 0px; transform: translate3d(67px, 0px, 0px);">
                        ...
                        <a href="#"
                            class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Microsoft
                            Surface Pro, Copilot+ PC, 13 Inch</a>
        ...
        <form action="#" method="get" id="filterModal" tabindex="-1" aria-hidden="true"
            class="fixed left-0 right-0 top-0 z-50 hidden h-modal w-full overflow-y-auto overflow-x-hidden p-4 md:inset-0 md:h-full justify-center items-center">
            <div class="relative h-full w-full max-w-xl md:h-auto">
                ...
                <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
                    ...
                    <div class="px-4 md:px-5">
                        <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                            <ul class="-mb-px flex flex-wrap text-center text-sm font-medium" id="myTab"
                                ...
                                <li class="mr-1" role="presentation">
                                    <button
                                        class="inline-block pb-2 pr-1 text-blue-600 hover:text-blue-600 dark:text-blue-500 dark:hover:text-blue-500 border-blue-600 dark:border-blue-500"
                                        id="brand-tab" data-tabs-target="#brand" type="button" role="tab"
                                        aria-controls="profile" aria-selected="true">Brand</button>
                                </li>
                                <li class="mr-1" role="presentation">
                                    <button
                                        class="inline-block px-2 pb-2 hover:border-gray-300 hover:text-gray-600 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700"
                        ...
                        <div class="space-y-4 hidden" id="advanced-filters" role="tabpanel"
