                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="#"
                                        class="ms-1 text-sm font-medium text-gray-700 hover:text-primary-600 dark:text-gray-400 dark:hover:text-white md:ms-2">185</a>
                                </div>
                            </li>
                    ...
                    <div class="h-56 w-full">
                        <a href="#">
                            <img class="mx-auto h-full dark:hidden"
                                src="https://productimages.hepsiburada.net/s/67/222-222/110000009217029.jpg/format:webp" alt="">
                            <img class="mx-auto hidden h-full dark:block"
                                src="
                                https://productimages.hepsiburada.net/s/67/222-222/110000009217029.jpg/format:webp" alt="">
                        </a>
                    </div>
                    <div class="pt-6">
                        ...
                        <a href="#"
                            ...
                            Michelin Pilot Sport 4 225/45 R17 91Y XL Lastik
                        </a>
